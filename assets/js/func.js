...
function showalert(msg) {
  alerty.alert(msg, { title: " تنبيه ⚠️" }, function () {
    try {
      setcanback("alerty");
    } catch (err) {}
  });
...
function server_erorr() {
  alerty.alert(
    " حدث خطأ في الخادم من فضلك أعد المحاولة بعد قليل ",
    { title: "خطأ" },
    function () {
      try {
        setcanback("alerty");
...
function app_new_update() {
  alerty.confirm(
    ...
    { title: " انتباه ", cancelLabel: "تحديث", okLabel: "لاحقأ" },
    function () {
      setcanback("");
    },
    function () {
      location.replace(
        "https://play.google.com/store/apps/details?id=name.mixalwan.com"
      );
      setcanback("");
    }
  );
...
function app_need_update() {
  alerty.confirm(
    ...
    { title: " تحديث ", cancelLabel: "تحديث", okLabel: "لاحقأ" },
    function () {
      setcanback("");
    },
    function () {
...
function dir_erorr() {
  alerty.alert(
    " للاستمرار يجب تثبيت التطبيق من متجر جوجل بلاي حصراً ",
    { title: "خطأ" },
    function () {
      setcanback("");
    }
...
function show_toast_msg(msg) {
  nativeToast({ message: msg, position: "center" });
}
function fav_found() {
  nativeToast({
...
function phone_id_not_support() {
  alerty.confirm(
    ...
    { title: " خطأ ", cancelLabel: "اتصل بالأدارة", okLabel: "حسناً" },
    function () {
      setcanback("");
    },
    function () {
