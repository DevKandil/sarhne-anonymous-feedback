...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($count > 0) {
        ...
        if ($count > 0) {  // User Registered Successfully
        ...
        <div id="center">
            <div class="center">
                ...
                <form action="" method="POST" id="form_singin" style="text-align: -webkit-center">
                    ...
                    <input type="submit" name="submit" value="إنشاء حساب" id="login" class="flatbutton" style="background-color:#2D2F31;width:90%;border:0; cursor: pointer; font-family: cairo">
